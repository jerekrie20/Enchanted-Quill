<div class="min-h-screen bg-gradient-to-b from-bg via-bg to-lightGray/20 dark:from-navbg dark:via-navbg dark:to-accent/10">
    ...
    <header class="bg-navbg relative py-8 border-b-2 border-purple-500/20">
        ...
        <div class="max-w-4xl mx-auto px-4">
            ...
            <nav class="mb-6" aria-label="Breadcrumb">
                <a href="{{ route('portal.chronicles') }}" wire:navigate class="text-white/80 hover:text-violet-400 font-serif text-sm transition-colors inline-flex items-center gap-2" aria-label="Return to Chronicles list">
    ...
    <section class="py-12">
        <div class="max-w-4xl mx-auto px-4">
            ...
            {{-- Share and Actions --}}
            <div class="relative bg-white/60 dark:bg-accent/20 backdrop-blur-sm border-2 border-purple-500/20 p-6 rounded-sm mb-12">
                ...
                <div class="flex items-center justify-between flex-wrap gap-4">
                    <div class="flex items-center gap-4" role="group" aria-label="Share this article">
                        ...
                        <button class="w-10 h-10 bg-purple-500/10 hover:bg-purple-500/20 text-purple-600 dark:text-violet-400 rounded-full flex items-center justify-center transition-colors border border-purple-500/20" aria-label="Share on Facebook">
                            <i class="fa-brands fa-facebook" aria-hidden="true"></i>
                        </button>
                        <button class="w-10 h-10 bg-purple-500/10 hover:bg-purple-500/20 text-purple-600 dark:text-violet-400 rounded-full flex items-center justify-center transition-colors border border-purple-500/20" aria-label="Share on LinkedIn">
                            <i class="fa-brands fa-linkedin" aria-hidden="true"></i>
                        </button>
                        <button class="w-10 h-10 bg-purple-500/10 hover:bg-purple-500/20 text-purple-600 dark:text-violet-400 rounded-full flex items-center justify-center transition-colors border border-purple-500/20" aria-label="Copy link to clipboard">
                            <i class="fa-solid fa-link" aria-hidden="true"></i>
                        </button>
                    </div>
                    @auth
                        <button class="relative px-4 py-2 bg-violet-500/10 hover:bg-violet-500/20 text-violet-600 dark:text-violet-300 rounded-sm font-serif transition-colors inline-flex items-center gap-2 border border-violet-500/30" aria-label="Save this article to your bookmarks">
            ...
            {{-- Author Bio --}}
            <aside class="relative bg-white/80 dark:bg-accent/30 backdrop-blur-sm border-2 border-purple-500/20 p-6 rounded-sm" aria-label="About the author">
                <div class="absolute top-0 left-0 w-4 h-4 border-t-2 border-l-2 border-purple-500/50"></div>
                <div class="absolute top-0 right-0 w-4 h-4 border-t-2 border-r-2 border-purple-500/50"></div>
    ...
    <section class="py-12 border-t-2 border-purple-500/20" aria-label="Comments section">
        <div class="max-w-4xl mx-auto px-4">
            ...
            @auth
                <div class="relative bg-white/80 dark:bg-accent/30 backdrop-blur-sm border-2 border-purple-500/20 p-6 rounded-sm mb-8">
                    <div class="absolute top-0 left-0 w-3 h-3 border-t-2 border-l-2 border-purple-500/50"></div>
                    <div class="absolute top-0 right-0 w-3 h-3 border-t-2 border-r-2 border-purple-500/50"></div>
