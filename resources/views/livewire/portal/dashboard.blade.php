        ...
        <section aria-labelledby="recent-books-heading" class="relative">
            ...
            @else
                <div class="text-center py-12 bg-white/60 dark:bg-accent/20 backdrop-blur-sm border-2 border-purple-500/20 rounded-sm">
                    ...
                    <p class="text-text/60 font-serif">No books available yet. Check back soon!</p>
                </div>
            @endif
        </section>
        ...
        <div class="relative bg-white/60 dark:bg-accent/20 backdrop-blur-sm border-2 border-violet-400/20 dark:border-violet-400/10 p-8 lg:p-10">
            ...
            @else
                <div class="text-center py-12 bg-white dark:bg-navbg/40 border border-violet-400/20">
                    <svg class="w-16 h-16 text-violet-400/20 mx-auto mb-4" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/>
                    </svg>
                    <p class="text-text/60 font-serif">No popular books yet. Be the first to review!</p>
                </div>
            @endif
        </div>
    </section>
        ...
        <div class="text-center mb-8">
                            ...
                            <a href="{{ route('portal.chronicle.show', $chronicle->id) }}" wire:navigate class="block">
                                @if($chronicle->image)
                                    <div class="aspect-video overflow-hidden">
                                        <img src="{{ asset('storage/' . $chronicle->image) }}"
            ...
            @else
                <div class="text-center py-12 bg-white/60 dark:bg-accent/20 backdrop-blur-sm border-2 border-purple-500/20 rounded-sm">
                    ...
                    <p class="text-text/60 font-serif">No chronicles available yet. Check back soon!</p>
                </div>
            @endif
    </section>
